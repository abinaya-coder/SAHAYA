"""
SAHAYA Synthetic Demo Cases Dataset (8 Cases)
Contains realistic synthetic cases with multilingual transcripts, timelines,
SVI metrics, evidence highlights, and support pathways.
"""
        ...
        "indicators": [
            {
                "type": "THREAT",
                "severity": "HIGH",
                "evidence": "மிரட்டினார்கள்",
                "translatedEvidence": "threatened",
                "confidence": 0.91
            },
            {
                "type": "FEAR_DISTRESS",
                "severity": "HIGH",
                "evidence": "பயமாக இருக்கிறது",
                "translatedEvidence": "afraid",
                "confidence": 0.88
            },
            {
                ...
                "severity": "HIGH",
                "evidence": "மீண்டும்",
                "translatedEvidence": "again",
                "confidence": 0.95
            },
            {
                "type": "IMMEDIATE_SAFETY",
                "severity": "CRITICAL",
                "evidence": "வீட்டிற்கு போகவே பயமாக",
                "translatedEvidence": "afraid to go home",
                "confidence": 0.90
            }
        ],
        "evidenceList": [
